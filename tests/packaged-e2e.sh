...
"$CLI" automate assert 'shaFailed' 'hfPrivateRejected' 'hfAmbiguousRejected' 'hfIncompatibleRejected' 'pendingResumeHydrated' 'durationSeconds' 'reasonMatched' 'droppedFrameFailure' 'processTranslated' >/dev/null
