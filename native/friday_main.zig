...
const app_extension = @import("app_extension");
...
pub fn main(init: std.process.Init) !void {
    ...
    const friday_host = try app_extension.FridayHost.create(std.heap.page_allocator, init.io, app_data_dir);
    defer friday_host.destroy();
